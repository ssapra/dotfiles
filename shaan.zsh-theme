...
elif [ "$POWERLINE_HIDE_USER_NAME" != "false" ] && [ "$POWERLINE_HIDE_HOST_NAME" = "false" ]; then
    POWERLINE_USER_NAME="@%M"
elif [ "$POWERLINE_HIDE_USER_NAME" = "true" ] && [ "$POWERLINE_HIDE_HOST_NAME" != "false" ]; then
